...
(function () {
  ...
  var RUNS = [
    { at: daysAgo(31), freed: 18.2*GB, sections: 11, mode:'all' },
    { at: daysAgo(24), freed:  6.1*GB, sections: 11, mode:'all' },
    { at: daysAgo(18), freed:  9.7*GB, sections:  7, mode:'profile dev' },
    { at: daysAgo(14), freed:  2.4*GB, sections:  4, mode:'only 7,9,10' },
    { at: daysAgo(10), freed: 13.9*GB, sections: 11, mode:'all' },
    { at: daysAgo(6),  freed:  4.8*GB, sections:  6, mode:'profile cache-only' },
    { at: daysAgo(3),  freed:  7.2*GB, sections: 11, mode:'all' },
    { at: daysAgo(1),  freed:  3.3*GB, sections:  5, mode:'only 1,2,6' }
  ];
