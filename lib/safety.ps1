...
# Running an external process, and asking about / raising privilege, moved to lib/external.ps1 at the
# 1.3.0 cascade (RW-121): Invoke-External, Test-CommandPresent, Test-ProcessRunning, Test-IsAdmin,
# Test-CanElevate and Invoke-Elevated. The deletion chokepoint stays here, which is the point of the split.
