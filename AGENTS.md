...
skill-less. (Owner directive 2026-07-11; full text in `~/.claude/AGENTS.md`.)
...
`static/assets/claude-code/`; the `~/.claude/...` paths are symlinks into it. Full text: `~/.claude/AGENTS.md`.
