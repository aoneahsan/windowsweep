...
🔴 **Every dated `## Amendment` section moved out of this file on 2026-09-17 (TASK-014)**, which had reached
1,039 lines against this repository's 500-line rule. They moved **verbatim** - nothing reworded, nothing
dropped, proved by comparing the sorted non-blank lines of the original against the sorted non-blank lines of
the files it became.
...
reason here, and only then does the app match (`~/.claude/rules/frontend-ui-standards.md` §10a).
