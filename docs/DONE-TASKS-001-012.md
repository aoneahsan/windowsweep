# Done tasks - windowsweep, DONE-001 to DONE-012

The first twelve closed agent follow-ups, moved here **verbatim and in their original order** from
[`DONE-TASKS.md`](DONE-TASKS.md) on 2026-09-26, when that file passed its 500-line ceiling. Nothing was reworded;
every later entry, and every new one, lives in `DONE-TASKS.md`.
...
Last Updated: 2026-09-26 (created by the verbatim move of DONE-001 to DONE-012 from `DONE-TASKS.md`)
